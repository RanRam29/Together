-- Migration: WP13 Progress Report (D53)
-- Adds RPC to fetch child progress report for parents without leaking sensitive info.
...
BEGIN
  ...
  match_reporting AS (
    SELECT l.match_id, count(*) as logs_count, avg(l.mood) as mood_avg
    FROM daily_logs l
